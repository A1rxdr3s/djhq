    ...
    <section className="relative overflow-hidden pt-16">
      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-4rem)] max-w-7xl items-center px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
        ...
        <div className="flex flex-col justify-center py-16 lg:py-24">
          ...
          <p
            className="mt-6 max-w-[400px] text-[15px] leading-[1.72] text-white/40 motion-safe:[animation:hp-fade-up_0.65s_ease_both]"
          ...
          <p
            className="mt-8 font-mono text-[10px] uppercase tracking-[0.24em] text-white/18 motion-safe:[animation:hp-fade-up_0.65s_ease_both]"
        ...
        >
          <div className="relative w-full overflow-hidden rounded-[20px] border border-white/[0.07] shadow-2xl shadow-black/60 transition-all duration-500 hover:-translate-y-1.5 hover:border-white/[0.11] hover:[box-shadow:0_16px_56px_color-mix(in_srgb,var(--accent)_6%,transparent),0_28px_64px_rgba(0,0,0,0.75)]">
            ...
            {/* Artist header — photo as banner, not portrait hero */}
            <div className="relative h-[108px] overflow-hidden sm:h-[120px]">
              <Image
            ...
            {/* Profile sections — this is the product */}
            <div className="divide-y divide-white/[0.04] bg-background">

              {/* Releases */}
              <div className="px-5 py-4">
                <p className="mb-3 text-[9px] font-bold uppercase tracking-[0.28em] text-accent/50">
                  Releases
                </p>
                <div className="flex items-center gap-3">
                  {/* Gradient artwork thumbnails */}
                  <div
              ...
              <div className="px-5 py-4">
                ...
                <div className="space-y-2.5">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-[12px] font-semibold uppercase tracking-[0.02em] text-white/75">
                        ICE Festival
                      </p>
                      <p className="text-[10px] text-white/32">Buenos Aires · Feb 2025</p>
                    </div>
                    <span className="rounded-full border border-white/[0.08] px-2.5 py-0.5 text-[9px] font-medium text-white/35">
                      Tickets
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between px-5 py-4">
                <div>
                  <p className="text-[9px] font-bold uppercase tracking-[0.28em] text-accent/50">
                    Press Kit
                  </p>
