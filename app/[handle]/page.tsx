              ...
              <div className="absolute inset-x-0 bottom-[28%] z-10 flex flex-col items-center px-6 text-center sm:hidden">
                {(displayHeroTagline || credibilityLine) && (
                  <div className="mb-7 flex flex-col items-center gap-2">
                    ...
                    {credibilityLine && (
                      <p className="max-w-[260px] text-balance text-center text-[12px] font-medium leading-[1.55] text-white/80">
                        {credibilityLine}
                      </p>
                    )}
                  </div>
              ...
              <div className="absolute inset-x-0 top-[47%] z-10 hidden flex-col items-center px-4 text-center sm:flex sm:top-[38%]">
                ...
                {(displayHeroTagline || credibilityLine) && (
                  <div className="mt-4 flex flex-col items-center gap-2 sm:mt-11">
                    ...
                    {credibilityLine && (
                      <p
                        className="max-w-2xl text-pretty text-center text-[13px] font-medium leading-[1.55] text-white/82"
              ...
              <div className="absolute inset-x-0 bottom-[14%] z-10 flex flex-col items-center px-4 text-center sm:bottom-[16%]">
                {(displayHeroTagline || credibilityLine) && (
                  <div className="mb-5 flex flex-col items-center gap-2">
                    ...
                    {credibilityLine && (
                      <p
                        className="max-w-[260px] text-pretty text-center text-[13px] font-medium leading-[1.55] text-white/80 sm:max-w-2xl"
