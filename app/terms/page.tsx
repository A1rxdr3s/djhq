...
export const metadata: Metadata = {
  ...
  description: `Terms of use for ${brand.name} artist websites.`,
}
    ...
    <main className="min-h-screen text-white">
      <div className="mx-auto max-w-[680px] px-6 pb-20 pt-10 sm:pt-14">
        ...
        <p className="mb-9 rounded-lg border border-white/[0.06] bg-white/[0.02] px-5 py-4 text-[13px] leading-relaxed text-white/40">
          By using this artist website you agree to the following terms. These pages are powered
          by {brand.name} and are subject to these terms in addition to {brand.name}&apos;s own
          platform policies.
        </p>
        ...
        <div className="space-y-10">
          ...
          <Section n={2} title="Content Ownership">
            <p>
              All artist content on this website — including name, likeness, biography, photos, logos,
              music, and related creative assets — remains the property of the artist or their
              respective rights holders. {brand.name} does not claim ownership of artist content.
            </p>
            <p>
              ...
              commercial purposes, altered to misrepresent the artist, or republished out of context.
            </p>
          </Section>
          ...
          <Section n={3} title="Booking Inquiries">
            <p>
              ...
              their representatives, not by {brand.name}.
            </p>
          </Section>
          ...
          <Section n={4} title="Audience Signup">
            <p>
              ...
              requesting removal through our{" "}
          ...
          <Section n={6} title="Site Availability">
            <p>
